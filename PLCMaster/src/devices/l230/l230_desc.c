...
static const TagDesc_t L230_TAGS[] = {
    ...
    { "X21_CPU_Pt1.Pt_Value", TAG_DIR_IN, TAG_T_REAL, (uint32_t)(offsetof(L230_TX_PDO_t, X21_CPU_Pt1) + offsetof(L230_Pt_t, Pt_Value)), 0, NULL, NULL },
    { "X21_CPU_Pt1.Pt_State", TAG_DIR_IN, TAG_T_U32, (uint32_t)(offsetof(L230_TX_PDO_t, X21_CPU_Pt1) + offsetof(L230_Pt_t, Pt_State)), 0, NULL, NULL },
    { "X22_CPU_Pt2.Pt_Value", TAG_DIR_IN, TAG_T_REAL, (uint32_t)(offsetof(L230_TX_PDO_t, X22_CPU_Pt2) + offsetof(L230_Pt_t, Pt_Value)), 0, NULL, NULL },
    { "X22_CPU_Pt2.Pt_State", TAG_DIR_IN, TAG_T_U32, (uint32_t)(offsetof(L230_TX_PDO_t, X22_CPU_Pt2) + offsetof(L230_Pt_t, Pt_State)), 0, NULL, NULL },
    { "X23_CPU_VC1.VC_Value", TAG_DIR_IN, TAG_T_REAL, (uint32_t)(offsetof(L230_TX_PDO_t, X23_CPU_VC1) + offsetof(L230_VC_t, VC_Value)), 0, NULL, NULL },
    { "X23_CPU_VC1.VC_State", TAG_DIR_IN, TAG_T_U32, (uint32_t)(offsetof(L230_TX_PDO_t, X23_CPU_VC1) + offsetof(L230_VC_t, VC_State)), 0, NULL, NULL },
